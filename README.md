...
## 一、系统介绍
该系统既适用于企业用户，也适用于学生用户，企业用户可以用此系统进行市场调研、客户满意度调查、公共事务调查等，学生用户可以参考该系统进行毕业设计、论文撰写等。
...
-- 不同于市面上的一些陈年老项目，技术老旧，文档匮乏，上手难度大。

2、完全自主开发，源码可控；

-- 不同于市面上倒了N手的项目，源码架构和系统功能完全不可控，何谈专业指导。
...
1、admin账号提供了该系统所有功能的展示，部分系统级功能做了 API 级别的限制，仅供功能展示用途；
